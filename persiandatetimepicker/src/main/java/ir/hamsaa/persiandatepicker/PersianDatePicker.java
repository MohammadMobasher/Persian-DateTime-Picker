...
class PersianDatePicker extends LinearLayout {
    ...
    private PersianNumberPicker HourNumberPicker;
    private PersianNumberPicker MinNumberPicker;
    ...
    public PersianDatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        MinNumberPicker = view.findViewById(R.id.MinNumberPicker);
        ...
        HourNumberPicker.setFormatter(new NumberPicker.Formatter() {
            ...
            public String format(int i) {
                if(i >= 0 && i <= 9)
                    return "۰" + PersianHelper.toPersianNumber(i + "");
                return PersianHelper.toPersianNumber(i + "");
            }
        });
    ...
    public void setBackgroundColor(@ColorInt int color) {
        ...
        MinNumberPicker.setBackgroundColor(color);
    }
    ...
    public void setBackgroundDrawable(@DrawableRes int drawableBg) {
        ...
        MinNumberPicker.setBackgroundResource(drawableBg);
    }
    ...
    private void updateViewData() {
        ...
        if (typeFace != null) {
            ...
            MinNumberPicker.setTypeFace(typeFace);
        }
        ...
        if (dividerColor > 0) {
            ...
            setDividerColor(MinNumberPicker, dividerColor);
        }

        HourNumberPicker.setMinValue(00);
        HourNumberPicker.setMaxValue(23);

        MinNumberPicker.setMinValue(00);
        MinNumberPicker.setMaxValue(59);

        if(selectedHour < 0 || selectedHour > 23){
            throw new IllegalArgumentException(String.format("Selected Hour (%d) must be between 0 and 23", selectedMonth));
        }
        HourNumberPicker.setValue(selectedHour);

        if(selectedMin < 0 || selectedMin > 59){
            throw new IllegalArgumentException(String.format("Selected Minute (%d) must be between 0 and 59", selectedMonth));
        }
        MinNumberPicker.setValue(selectedMin);
    ...
    public String getStringPersianDate(){
        return (yearNumberPicker.getValue() < 10 ? "0" : "") + yearNumberPicker.getValue() + "/" + (monthNumberPicker.getValue() < 10 ? "0" : "") + monthNumberPicker.getValue() + "/" + (dayNumberPicker.getValue() < 10 ? "0" : "") + dayNumberPicker.getValue() + " " + (HourNumberPicker.getValue() < 10 ? "0" : "") + HourNumberPicker.getValue() + ":" + (MinNumberPicker.getValue() < 10 ? "0" : "") + MinNumberPicker.getValue() + ":00" ;
    }
