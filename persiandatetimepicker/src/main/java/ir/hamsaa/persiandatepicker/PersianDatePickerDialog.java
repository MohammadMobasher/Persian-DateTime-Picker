...
public class PersianDatePickerDialog {
    ...
    public PersianDatePickerDialog setInitHour(int Hour){
        this.initHour = Hour;
        return this;
    }

    public PersianDatePickerDialog setInitMin(int Min){
        this.initMin = Min;
        return this;
    }
    ...
    public void show() {
        ...
        if(initHour == -1)
            initHour = pCalendar.getHour();
        if(initMin == -1)
            initMin = pCalendar.getMin();

        datePicker.setSelectedHour(initHour);
        datePicker.setSelectedMin(initMin);
        ...
        positiveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (listener != null) {
                    ...
                    listener.onDateSelected(datePicker.getStringPersianDate());
                }
                dialog.dismiss();
            }
        });
